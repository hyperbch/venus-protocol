 ...
 * @author Venus
 */
contract ComptrollerLiquidationPublic is ComptrollerV7Storage, ComptrollerInterfaceG2, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function liquidateBorrowAllowed(
        ...
        if (address(vTokenBorrowed) != address(vaiController)) {
            ...
            borrowBalance = comptrollerLens.getVAIRepayAmount(address(this), borrower);
        }
